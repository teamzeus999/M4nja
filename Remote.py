#!/data/data/com.termux/files/usr/bin/usr/python
...
def banner():
	os.system('clear')
	print ("\033[1;31m       《□》---《□》---《□》---《□》---《□》 ")
	print ("\033[1;33m       |         Ken Arie Aditya           | ")
	print ("\033[1;33m       |        TOOLS ABANG GANTENG        | ")
	print ("\033[1;31m       《□》---《□》---《□》---《□》---《□》 ")
	print ("\033[1;37m         Author    : ZeusCyberTeam  ")
	print ("\033[1;37m         Whatsapp : 085213270579         ")
	print (" ")
